...
class ConnectionGene:
    ...
    def _get_correct_innovation_num(self):
        ...
        for connect_gene in ptneat.population.Population.current_gen_innovation:
            if self == connect_gene:
                return connect_gene.innov_num
        # Is new innovation
        ptneat.population.Population.current_gen_innovation.append(self)
        return ptneat.population.Population.get_new_innovation_num()
